...
<div class="fixedly-cont-<?php print \$wp_query->post->ID;?>">
    ...
    <div class="fixedly-inner-nav-<?php print \$wp_query->post->ID;?>" style="width: {$rows_affected[0]->col_right_width}px;">
    ...
    <div class="fixedly-inner-cont-<?php print \$wp_query->post->ID;?>">
        ...
        <div class="fixedly-inner-<?php print \$wp_query->post->ID;?>">
            ...
            <div class="fixedly-inner-left" style="width: {$rows_affected[0]->col_left_width}px;">
                <a href="<?php print \$rows_affected[\$row]->link;?>" class="fancybox" rel="fixedly-gallery"><img src="<?php print \$rows_affected[\$row]->link;?>" alt="<?php print \$rows_affected[\$row]->title;?>" style="width: <?php print '{$rows_affected[0]->col_left_width}px';?>; height: <?php print '{$rows_affected[0]->col_height}px';?>" /></a>
            </div>
            <div class="fixedly-inner-right" style="width: {$rows_affected[0]->col_right_width}px;">
...
.fixedly-inner-left {{$rows_affected[0]->style_fixedly_inner_left}}
.fixedly-inner-right {{$rows_affected[0]->style_fixedly_inner_right}}
</style>
